...
int main(int argc, char** argv) {
    ...
    // Input Data
    std::vector<float> input_data = {3.0, 3.0, 3.0, 3.0};
    ...
    const std::unique_ptr<Vdtom_softmax> top{new Vdtom_softmax{contextp.get(), "dtom_softmax"}};

    top->trace(m_trace, 99);
    m_trace->open("sim_dtom_softmax.vcd");
